class Boot extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(`can_me`, `assets/images/can_me.png`);
    this.load.image(`can_1`, `assets/images/can_1.png`);
    this.load.image(`can_2`, `assets/images/can_2.png`);
    this.load.image(`can_3`, `assets/images/can_3.png`);
    this.load.image(`can_4`, `assets/images/can_4.png`);
